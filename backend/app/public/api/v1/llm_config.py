...
@router.get("/", response_model=Optional[LLMConfigResponse])
...
async def test_llm_config(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to test LLM configuration")
...
async def delete_llm_config(
    ...
    try:
        ...
        if not success:
            raise HTTPException(
                status_code=404,
                detail="No LLM configuration found to delete"
            )
