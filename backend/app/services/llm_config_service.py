...
class LLMConfigService:
    ...
    def get_user_config(self, db: Session, user_id: int) -> Optional[LLMConfigResponse]:
    ...
    async def _test_openai_config(self, config: LLMConfigResponse, test_message: str) -> tuple[bool, str]:
    ...
    async def _test_anthropic_config(self, config: LLMConfigResponse, test_message: str) -> tuple[bool, str]:
    ...
    async def _test_google_config(self, config: LLMConfigResponse, test_message: str) -> tuple[bool, str]:
