...
class TestAdminLLMConfigEndpoints:
    ...
    def test_get_user_llm_config_success(self, private_client: TestClient, mock_db: Session, auth_headers):
    ...
    def test_get_user_llm_config_not_found(self, private_client: TestClient, mock_db: Session, auth_headers):
    ...
    def test_create_user_llm_config_success(self, mock_fernet, private_client: TestClient, mock_db: Session, auth_headers):
    ...
    @patch('app.private.api.v1.admin.llm_config.fernet')
    def test_update_user_llm_config_success(self, mock_fernet, private_client: TestClient, mock_db: Session, auth_headers):
    ...
    @patch('app.private.api.v1.admin.llm_config.fernet')
    def test_test_user_llm_config_success(self, mock_fernet, mock_create_agent, private_client: TestClient, mock_db: Session, auth_headers):
    ...
    @patch('app.private.api.v1.admin.llm_config.create_agent')
    @patch('app.private.api.v1.admin.llm_config.fernet')
    def test_test_user_llm_config_failure(self, mock_fernet, mock_create_agent, private_client: TestClient, mock_db: Session, auth_headers):
