...
@patch("app.private.api.v1.health.get_database_manager")
@patch("httpx.AsyncClient")
def test_readiness_check_database_unhealthy(mock_httpx_client, mock_get_db_manager, client):
...
@patch("app.private.api.v1.health.get_database_manager")
@patch("httpx.AsyncClient")
def test_readiness_check_bridge_unhealthy(mock_httpx_client, mock_get_db_manager, client):
